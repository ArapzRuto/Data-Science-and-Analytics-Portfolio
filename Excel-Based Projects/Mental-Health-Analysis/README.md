...
Project Overview
The Mental Health Analysis Dashboard is an interactive Excel dashboard that analyzes mental health survey data to uncover patterns in stress levels, mental health conditions, treatment-seeking behavior, workload, sleep quality, exercise habits, job satisfaction, and demographic characteristics.
